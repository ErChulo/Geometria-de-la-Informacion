...
\begin{enumerate}
	...
	\item \textbf{Resp.:} $D_{\mathrm{KL}}(p \| q) = 0.8\log(0.8/0.3) + 0.2\log(0.2/0.7) \approx 0.5390$; $D_{\mathrm{KL}}(q \| p) = 0.3\log(0.3/0.8) + 0.7\log(0.7/0.2) \approx 0.6395$.
	\item \textbf{Resp.:} $D_{\mathrm{KL}}(\mathrm{Poisson}(3) \| \mathrm{Poisson}(5)) = 3\log(3/5) - 3 + 5 = -3\log(5/3) + 2 \approx 0.2811$.
	\item \textbf{Resp.:} $D_{\mathrm{KL}}(\mathrm{Poisson}(5) \| \mathrm{Poisson}(3)) = 5\log(5/3) - 5 + 3 = 5\log(5/3) - 2 \approx 0.5108$.  No es igual: la KL es asimétrica.
	\item \textbf{Resp.:} $D_{\mathrm{KL}} = \log(\lambda_2/\lambda_1) + \lambda_1/\lambda_2 - 1$.  Se verifica directamente de la definición.
	...
	\item \textbf{Resp.:} Ejemplo: $p = \mathrm{Bern}(0.9)$, $q = \mathrm{Bern}(0.5)$, $r = \mathrm{Bern}(0.1)$.  $D(p \| q) \approx 0.531$, $D(q \| r) \approx 0.693$, $D(p \| r) \approx 1.204 > 0.531 + 0.693$ (se viola la desigualdad triangular).
