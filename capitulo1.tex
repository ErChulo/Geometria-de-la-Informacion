...
\begin{center}
	\begin{tikzpicture}[scale=0.8]
		\draw[thick, Accent, fill=AccentLight!10, rounded corners] (0,0) to[out=10,in=170] (6,0) to[out=-10,in=190] (6,3) to[out=10,in=170] (0,3) -- cycle;
		\node[AccentDark, font=\small] at (3,1.5) {Variedad $S$};
		\fill[AccentDark] (1.5,2) circle (2pt) node[above, font=\small] {$p_{\theta_1}$};
		\fill[AccentDark] (4.5,1.5) circle (2pt) node[below right, font=\small] {$p_{\theta_2}$};
		\draw[->, thick, AccentDark] (1.5,2) -- (4.5,1.5) node[midway, above, font=\scriptsize] {geodésica};
		\begin{scope}[shift={(1.5,2)}]
			\draw[->, thick, red!70!black] (0,0) -- (1.2,0.8) node[right, font=\scriptsize] {$d\theta$};
			\draw[->, thick, blue!70!black] (0,0) -- (-0.8,1) node[left, font=\scriptsize] {$\delta\theta$};
			\node[font=\scriptsize, red!70!black] at (0.6,-0.4) {$T_{\theta_1}S$};
		\end{scope}
	\end{tikzpicture}
\end{center}
