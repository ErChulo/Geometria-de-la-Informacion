...
\begin{quotation}
	\itshape
	``Antes de hablar de curvatura en el espacio de distribuciones, asegúrate de que el álgebra lineal, el cálculo y la probabilidad sean tus aliados, no tus enemigos.''
\end{quotation}

	\bigskip
	\noindent
	Este capítulo es un \textbf{workbook de auto-prueba}, no una exposición lineal: cada enunciado lleva su respuesta pegada debajo, de modo que puedas medir de inmediato cuánto recuerdas y dónde necesitas repasar antes de entrar a la geometría de la información. Si al leer un apartado sientes que la respuesta te sorprende ---o, peor, que la darías distinta---, vuelve a la sección homónima de tu manual favorito: ese hueco es el prerrequisito que el Capítulo~1 va a asumir. Estructuramos el material en ocho bloques ---álgebra lineal, cálculo multivariable, probabilidad, estadística matemática, análisis convexo, geometría diferencial, teoría de la información, procesos y programación científica--- siguiendo el orden lógico en el que aparecerán en el libro.
	...
	\bigskip
	\noindent
	Si esta revisión de prerrequisitos te ha dejado con más confianza que al empezarla ---incluso si algunas respuestas te han sorprendido---, estás listo para el Capítulo~1: instalaremos la métrica de Fisher, demostraremos su unicidad por Chentsov, y exhibiremos el primer caso en que la geometría no es llana ---el semiplano de Poincaré escondido en el espacio $(\mu,\sigma)$ de la Gaussiana---. Los prerrequisitos que detonaron tus dudas aquí son los que reaparecerán, ahora con geometría, en los capítulos siguientes.
