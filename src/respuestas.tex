...
\begin{enumerate}
	\item \textbf{[Cauchy Fisher]} Para $\theta$ localizaci\'on, $\partial_\theta\ell = 2(x-\theta)/(1+(x-\theta)^2)$. Cuadrado esperado bajo $P_\theta$: $\int \frac{1}{\pi}\frac{4u^2}{(1+u^2)^2}\,du=1/2$, donde $u=x-\theta$. Por tanto $I(\theta)=1/2$ (constante, independiente de $\theta$; geometr\'ia plana).
