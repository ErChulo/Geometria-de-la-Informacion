...
La métrica de Fisher $g_{ij}(\theta)$ describe cuánto cuesta moverse infinitesimalmente. El tensor de Riemann $R^a_{bcd}$ requiere $\ge 2$ parámetros para tener un par antisimétrico $(b,d)$ no trivial que pueda ser no nulo. Cualquier familia 1D es \emph{geométricamente plana} por construcción.
\end{remark}
\end{example}
