...
\begin{enumerate}[resume]
	...
	\item Para la familia exponencial $\mathrm{Exp}(\lambda)$, muestre que $D_{\mathrm{KL}}(\mathrm{Exp}(\lambda_1) \| \mathrm{Exp}(\lambda_2)) = \log(\lambda_1/\lambda_2) + \lambda_2/\lambda_1 - 1$.
